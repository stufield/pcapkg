...
test_that("plot_pca_dims() controls point appearance via 'pt.cex' and 'pt.bg'", {
  expect_snapshot_plot(
...
test_that("plot_pca_dims(add.ellipse = TRUE) adds an ellipse to the plot", {
  expect_snapshot_plot(
...
test_that("plot_pca_dims(add.ellipse = TRUE) adds an ellipse for each class", {
  expect_snapshot_plot(
