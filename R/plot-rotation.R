...
#' @param set1 Optional. A vector of `SeqIds` to mark on the plot. Typically
#'   a vector of analytes related to sample handling, or of other clinical
#'   relevance. Marked with a hollow diamond (see [pch()]).
#' @param set2 Optional. An additional vector of `SeqIds` to mark
#'   on the plot, separately from those in `set1`. Marked with a hollow
#'   triangle (see [pch()]).
#' @param set3 Optional. An additional vector of `SeqIds` to mark
#'   on the plot, separately from those in `set1`. Marked with a hollow
#'   square (see [pch()]).
#' @param set4 Optional. An additional vector of `SeqIds` to mark
#'   on the plot, separately from those in `set1`. Marked with a hollow
#'   circle (see [pch()]).
#' @param set5 Optional. An additional vector of `SeqIds` to mark
#'   on the plot, separately from those in `set1`. Marked with a hollow
