---
title: "Introduction to SomaPCA"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Introduction to SomaPCA}
...
Some modification of the standard \code{\link[stats]{prcomp}}) is performed.
Data transformations (e.g. centering and/or scaling) can be performed
via its arguments.

```{r pca}
pr <- pca(log10(splyr:::sim_test_data))
pr
```
